...
if(isset($_POST['add'])){
	...
	if(!empty($date)&&!empty($title)&&!empty($license)&&!empty($diminsion)&& !empty($format)&&!empty($image)&&!empty($tag)){
		$query="INSERT INTO `items`(`item_date`,`item_name`,`describtion`,`dimension`,`format`,`active`,`photo`,`tag`)
		VALUES ('$date','$title','$license','$diminsion','$format','$checked','$image','$tag')";
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method='POST' enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="Item-date">Item Date <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="Item-date" required="required" name=date class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat"  name=checkbox>
												</label>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="image" name="image" required="required" class="form-control" acccept='png'>
											</div>
										</div>
